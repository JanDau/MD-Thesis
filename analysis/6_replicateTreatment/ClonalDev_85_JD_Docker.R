...
# -----------------------
  ...
  usr[["order"]] <- "first" # sequence stack order based on "first", "last", "overall"
  usr[["bar.width"]] <- 0.65 # width of columns, values between 0.00 and 1.00
  usr[["width"]] <- 826 # width of plot in px, set NA for automatic
  usr[["height"]] <- 531 # height of plot in px, set NA for automatic
