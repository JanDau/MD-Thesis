...
user_fixed_CD = 5	# Option whether a fix CD should be used or not. Possible values: False, 1, 2, 3, ...
...
highestDeviation = 5	# With this number you can decide which sequences are allowed to create a cluster where other sequences can be grouped to
